...
<h1 class="text-3xl font-bold mb-4 text-center">📦 我的个人站</h1>
<div id="status-bar" class="bg-yellow-900/50 border border-yellow-700 rounded-lg p-4 mb-6 text-center">
  <p class="text-yellow-200 font-medium">⏳ 正在连接 Supabase...</p>
</div>
...
<p class="text-gray-400 mb-3">选择文件保存到本地，并记录备份历史</p>
...
<button onclick="backupFile()" class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded font-medium">💾 备份到本地</button>
</div>
